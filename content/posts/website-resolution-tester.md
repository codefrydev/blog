...
**Try it here:** [codefrydev.in/WebsiteResolutionTester](https://codefrydev.in/WebsiteResolutionTester/)
...
1. Go to [Website Resolution Tester](https://codefrydev.in/WebsiteResolutionTester/)
2. Enter your site URL (e.g. `example.com` or `https://yoursite.com`)
3. Pick a device preset or set custom width and height
4. Click **Launch Test**
5. If your browser blocks the popup, allow popups for the site—sized windows are how the tool simulates each device
...
**[Open Website Resolution Tester →](https://codefrydev.in/WebsiteResolutionTester/)**
